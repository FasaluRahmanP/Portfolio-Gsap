...
export default function HomePage() {
  ...
  const letsTalkRef = useRef(null); // Added missing ref definition
  ...
  useEffect(() => {
    if (typeof window !== "undefined") {
      ...
      // Fixed the let's talk animation
  ...
  }, []); // Removed the nested return statement and fixed cleanup
  ...
  return (
    <main className={`transition-colors duration-300 ${theme === "dark" ? "bg-[#121212] text-white" : "bg-white text-black"} relative`}>
      {/* Navigation */}
      ...
      <div className="flex flex-col md:flex-row justify-between items-center px-6 py-12 md:py-24 min-h-screen">
        ...
        <div className="md:w-1/2 text-center md:text-left ml-16">
          <div className="mb-4 relative inline-block">
            <div className={`bg-[#d1ff4f] text-black text-4xl md:text-6xl font-albert font-extrabold py-3 px-4 -rotate-4 relative inline-block`}>
              CREATIVE
              <span className={`absolute top-0 right-0 text-[#d1ff4f] ${theme === "dark" ? "bg-[#121212]" : "bg-white"} translate-x-5 -translate-y-3 rounded-full w-10 h-10 flex justify-center items-center text-5xl font-bold`}>*</span>
            </div>
          </div>
      ...
      <div id="experience-section" ref={experienceRef} className="h-screen w-full overflow-hidden">
        <h1 className={`text-[40vw] uppercase font-medium ${theme === "dark" ? "text-white" : "text-black"} whitespace-nowrap`}>
          PORTFOLIO
        </h1>
      </div>
        ...
        <main className="max-w-4xl mx-auto mt-10">
          ...
          <div className="mt-8">
            <p className={`max-w-2xl ${theme === "dark" ? "text-gray-400" : "text-gray-600"}`}>
              ...
              intuitive and engaging digital experiences. With a background
              in [your background], I bring a unique perspective to every project I work on.
            </p>
          </div>
      ...
      <main className={`min-h-screen ${theme === "dark" ? "bg-[#121212] text-white" : "bg-white text-black"} px-4 md:px-8 py-12 transition-colors duration-300`}>
        <div className="max-w-6xl mx-auto">
          ...
          <section className="flex flex-col md:flex-row-reverse items-center justify-between mb-16 md:mb-24">
            <div className="md:w-1/2 mb-8 md:mb-0 md:pl-8">
              ...
              <p className={`${theme === "dark" ? "text-gray-400" : "text-gray-600"} max-w-md`}>
                A mobile application for an essential oils company that provides personalized recommendations and special
                offers based on customer preferences and usage patterns.
              </p>
            </div>
            <div className="md:w-1/2">
              <div className="aspect-square bg-indigo-700 w-full max-w-md mx-auto"></div>
  ...
  ref={letsTalkRef} 
  className="h-screen w-full overflow-hidden flex items-center justify-start px-10"
>
  <h5 
    className={`text-[20vw] uppercase font-medium ${theme === "dark" ? "text-white" : "text-black"} whitespace-nowrap -ml-[1500px]`}
